//
//  PlanningCitiesTableViewController.swift
//  BangBangGokGok
//
...
class PlanningCitiesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "planningCitiesTableCell", for: indexPath)
